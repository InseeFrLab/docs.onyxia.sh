...
{% hint style="info" %}
If you only need to change defaults/constraints, avoid forking catalogs. Use [values.schema.json overrides](https://app.gitbook.com/s/x3LIftMZY501x5liXUPV/admin-doc/catalog-of-services/override-schema-for-a-specific-instance).
{% endhint %}
...
{% content-ref url="https://app.gitbook.com/s/x3LIftMZY501x5liXUPV/admin-doc/catalog-of-services/custom-catalogs/onyxia-extension" %}
[x-onyxia](https://app.gitbook.com/s/x3LIftMZY501x5liXUPV/admin-doc/catalog-of-services/custom-catalogs/onyxia-extension)
{% endcontent-ref %}
